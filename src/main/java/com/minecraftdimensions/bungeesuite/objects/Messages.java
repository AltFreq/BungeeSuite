...
public class Messages {
	...
	public static String NO_PLAYERS_ONLINE = colorize(m.getString("NO_PLAYERS_ONLINE", "&c"
					+ "There must be players online to use this command"));
	public static String NO_PERMISSION = colorize(m.getString("NO_PERMISSION", "&c"
					+ "You do not have permission to use that command"));
	public static String PLAYER_COMMAND_ONLY = colorize(m.getString("PLAYER_COMMAND_ONLY", "&c"
					+ "This command can only be used by a player"));
	public static String SERVER_DOEST_NOT_EXIST = colorize(m.getString("SERVER_DOEST_NOT_EXIST", "&c"
	...
	public static String PLAYER_TELEPORT_PENDING_OTHER = colorize(m.getString("PLAYER_TELEPORT_PENDING_OTHER",
	...
	public static String PLAYER_REQUESTS_YOU_TELEPORT_TO_THEM = colorize(m
					.getString(
							"PLAYER_REQUESTS_YOU_TELEPORT_TO_THEM",
							"&2"
									+ "{player} has requested you teleport to them. Type /tpaccept to allow"));
	public static String TELEPORT_DENIED = colorize(m.getString("TELEPORT_DENIED", "&c"
					+ "You denied {player}'s teleport request"));
	public static String TELEPORT_REQUEST_DENIED = colorize(m.getString("TELEPORT_REQUEST_DENIED", "&c"
					+ "{player} denied your teleport request"));
	public static String NO_TELEPORTS = colorize(m.getString("NO_TELEPORTS",
			"&c" + "You do not have any pending teleports"));
	public static String TELEPORT_REQUEST_SENT = colorize(m.getString("TELEPORT_REQUEST_SENT", "&2"
					+ "Your request has been sent"));
	public static String TPA_REQUEST_TIMED_OUT = colorize(m.getString("TPA_REQUEST_TIMED_OUT", "&c"
					+ "Your request to teleport to {player} has timed out"));
	public static String TP_REQUEST_OTHER_TIMED_OUT = colorize(m.getString("TPA_REQUEST_OTHER_TIMED_OUT", "&c"
			+ "{player}'s teleport request has timed out"));
	public static String TPAHERE_REQUEST_TIMED_OUT = colorize(m
					.getString(
							"TPAHERE_REQUEST_TIMED_OUT",
							"&c"
									+ "Your request to have {player} teleport to you has timed out"));
	public static String NO_BACK_TP = colorize(m.getString("NO_BACK_TP",
			"&c" + "You do not have anywhere to go back to"));
	public static String SENT_BACK = colorize(m.getString("SENT_BACK", "&2"
			+ "You have been sent back"));
	public static String DEATH_BACK = colorize(m.getString("SENT_BACK", "&c"
			+ "Type /back to go back to your death point"));
	public static String TELEPORT_TOGGLE_ON = colorize(m.getString("TELEPORT_TOGGLE_ON", "&2"
			+ "Telports have been toggled on"));
	public static String TELEPORT_TOGGLE_OFF = colorize(m.getString("TELEPORT_TOGGLE_OFF", "&c"
			+ "Telports have been toggled off"));
	public static String TELEPORT_UNABLE = colorize(m.getString("TELEPORT_UNABLE", "&c"
			+ "You are unable to teleport to this player"));
	// warp specific messages
	public static String WARP_CREATED = colorize(m.getString("WARP_CREATED",
			"&2" + "Successfully created a warp"));
	public static String WARP_UPDATED = colorize(m.getString("WARP_UPDATED",
			"&2" + "Successfully updated the warp"));
	public static String WARP_DELETED = colorize(m.getString("WARP_DELETED",
			"&2" + "Successfully deleted the warp"));
	public static String WARP_ALREADY_EXISTS = colorize(m.getString("WARP_ALREADY_EXISTS", "&c"
					+ "Warp already exists"));
	...
	public static String PORTAL_CREATED = colorize(m.getString("PORTAL_CREATED", "&2"
					+ "You have successfully created a portal"));
	public static String PORTAL_UPDATED = colorize(m.getString("PORTAL_UPDATED", "&2"
			+ "You have successfully updated the portal"));
	public static String PORTAL_DELETED = colorize(m.getString("PORTAL_DELETED", "&c"
					+ "Portal deleted"));
	public static String PORTAL_FILLTYPE = colorize(m.getString("PORTAL_FILLTYPE", "&c"
					+ "That filltype does not exist"));
	public static String PORTAL_WRONG_TYPE = colorize(m
					.getString(
							"PORTAL_WRONG_TYPE",
							"&c"
									+ "That type of portal does not exist, please use warp or server"));
	public static String PORTAL_ALREADY_EXISTS = colorize(m.getString("PORTAL_ALREADY_EXISTS", "&c"
					+ "That portal already exists"));
	public static String PORTAL_DESTINATION_NOT_EXIST = colorize(m.getString("PORTAL_DESTINATION_NOT_EXIST", "&c"
					+ "That portal destination does not exist"));
	public static String PORTAL_DOES_NOT_EXIST = colorize(m.getString("PORTAL_DOES_NOT_EXIST", "&c"
					+ "That portal does not exist"));
	// Spawn messages
	public static String SPAWN_DOES_NOT_EXIST = colorize(m.getString("SPAWN_DOES_NOT_EXIST", "&c"
					+ "The spawn point has not been set yet"));
	public static String SPAWN_UPDATED = colorize(m.getString("SPAWN_UPDATED", "&2"
			+ "Spawn point updated"));
	public static String SPAWN_SET = colorize(m.getString("SPAWN_SET", "&2"
			+ "Spawn point set"));
	public static String TELEPORTED_TO_SPAWN = colorize(m.getString("TELEPORTED_TO_SPAWN", "&2"
			+ "You have been teleported to spawn"));
	// ban messages
	public static String KICK_PLAYER_MESSAGE = colorize(m.getString("KICK_PLAYER_MESSAGE", "&c"
					+ "You have been kicked for: {message}, by {sender}"));
	public static String KICK_PLAYER_BROADCAST = colorize(m.getString("KICK_PLAYER_BROADCAST", "&c"
					+ "{player} has been kicked for {message}, by {sender}!"));
	public static String SAME_IP = colorize(m.getString("SAME_IP", "&c"
			+ "{player} has the same ip as&2 {list} &cat ip: {ip}"));
	public static String PLAYER_ALREADY_BANNED = colorize(m.getString("PLAYER_ALREADY_BANNED", "&c"
					+ "That player is already banned"));
	public static String PLAYER_NOT_BANNED = colorize(m.getString("PLAYER_NOT_BANNED", "&c"
					+ "That player is not banned"));
	public static String IPBAN_PLAYER = colorize(m.getString("IPBAN_PLAYER", "&c"
					+ "You have been IP banned for: {message}, by {sender}"));
	public static String IPBAN_PLAYER_BROADCAST = colorize(m
			.getString("IPBAN_PLAYER_BROADCAST", "&c"
	...
	public static String PLAYER_BANNED_STILL_TEMP = colorize(m
					.getString(
							"PLAYER_BANNED_STILL_TEMP",
							"&c"
									+ "You are still temporarily banned for another: {date}"));
	public static String PLAYER_BANNED_STILL_MESSAGE = colorize(m.getString("PLAYER_BANNED_STILL_MESSAGE", "&c"
					+ "You have been banned for life for: {message}"));
	public static String PLAYER_BANNED_STILL = colorize(m.getString("PLAYER_BANNED_STILL", "&c"
	...
	public static String CHANNEL_DEFAULT_LOCAL =  m.getString(
			"CHANNEL_DEFAULT_LOCAL",
			"&9[Local]{prefix}&f{player}&f{suffix}&f: &7{message}");
	public static String CHANNEL_DEFAULT_ADMIN = m.getString("CHANNEL_DEFAULT_ADMIN",
							"&9[Admin]{player}:{message}");
	public static String CHANNEL_DEFAULT_FACTION = m.getString(
			"CHANNEL_DEFAULT_FACTION",
			"&a{factions_roleprefix}{factions_title}{player}:&r {message}");
	public static String CHANNEL_DEFAULT_FACTION_ALLY = m.getString(
			"CHANNEL_DEFAULT_FACTION_ALLY",
			"&d{factions_roleprefix}{factions_name}{player}:&r {message}");
	public static String PRIVATE_MESSAGE_OTHER_PLAYER = colorize(m.getString("PRIVATE_MESSAGE_OTHER_PLAYER", "&7"
					+ "[" + "&3" + "me" + "&7" + "->" + "&6" + "{player}"
					+ "&7" + "] {message}"));
	public static String PRIVATE_MESSAGE_RECEIVE = colorize(m.getString("PRIVATE_MESSAGE_RECEIVE", "&7"
					+ "[" + "&b" + "{player}" + "&7" + "->" + "&6" + "me"
					+ "&7" + "] {message}"));
	...
	public static String MUTED = colorize(m.getString("MUTED", "&c"
			+ "You have been muted"));
	public static String UNMUTED = colorize(m.getString("UNMUTED", "&2"
			+ "You have been unmuted"));
	public static String PLAYER_NOT_MUTE = colorize(m.getString("PLAYER_NOT_MUTE", "&c"
					+ "That player is not muted"));
	public static String NO_ONE_TO_REPLY = colorize(m.getString("NO_ONE_TO_REPLY", "&c"
					+ "You have no one to reply to"));
	public static String CHANNEL_DOES_NOT_EXIST = colorize(m.getString("CHANNEL_DOES_NOT_EXIST", "&c"
	...
	public static String CHATSPY_ENABLED = colorize(m.getString("CHATSPY_ENABLED", "&2"
					+ "ChatSpy enabled"));
	public static String CHATSPY_DISABLED = colorize(m.getString("CHATSPY_DISABLED", "&c"
					+ "ChatSpy disabled"));
	public static String CLEANCHAT_ENABLED = colorize(m.getString("CLEANCHAT_ENABLED", "&2"
					+ "CleanChat enabled"));
	...
	// home messages
	public static String HOME_NO_PERMISSION = colorize(m.getString("HOME_NO_PERMISSION", "&c"
					+ "You do not have permission to set a home here"));
	public static String HOME_NOT_SET = colorize(m
					.getString(
							"HOME_NOT_SET",
							"&c"
									+ "You do not have a home set in this world, returned to spawn"));
	public static String SENT_HOME = colorize(m.getString("SENT_HOME", "&2"
			+ "You have been sent home"));
	public static String HOME_NOT_EXIST = colorize(m.getString("HOME_NOT_EXIST", "&c"
					+ "Your home has not been set"));
	public static String NO_HOMES_ALLOWED = colorize(m.getString("NO_HOMES_ALLOWED", "&c"
					+ "Your are not able to set home in this server"));
	public static String NO_MORE_HOMES = colorize(m
					.getString(
							"NO_MORE_HOMES",
							"&c"
									+ "Your are not able to set any more homes in this server"));
	public static String HOME_UPDATED = colorize(m.getString("HOME_UPDATED",
			"&2" + "Your home has been updated"));
	public static String HOME_SET = colorize(m.getString("HOME_SET", "&2"
			+ "Your home has been set"));
	public static String HOME_DOES_NOT_EXIST = colorize(m.getString("HOME_DOES_NOT_EXIST", "&c"
					+ "That home does not exist"));
	public static String HOME_DELETED = colorize(m.getString("HOME_DELETED",
